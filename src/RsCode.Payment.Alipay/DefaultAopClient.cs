...
namespace Aop.Api
{
    ...
    public class DefaultAopClient : IAopClient
    {
        ...
        /// </summary>
        public const string SDK_VERSION = "alipay-sdk-net-4.1.0";
        ...
        {
            this.certEnvironment = new CertEnvironment(certParams);
        }
        ...
        public T CertificateExecute<T>(IAopRequest<T> request, string accessToken, string appAuthToken, String targetAppId) where T : AopResponse
        {
            ...
            {
                throw new AopException("证书相关参数没有初始化，请检查是否调用了正确的DefaultAopClient构造函数。");
            }
