...
namespace RsCode.Payment.Wxpay.Domain
{
    ...
    /// </summary>
    public class CouponQuery:WxPayData
    {
        #region 参数
        /// <summary>
        /// 代金券id
        /// </summary>
        [Required] [JsonPropertyName("coupon_id")] public string CouponId { get; set; }

        [Required] [JsonPropertyName("openid")] public string OpenId { get; set; }
        /// <summary>
        ...
        /// 批次号
        /// </summary>
        [Required] [JsonPropertyName("stock_id")] public string StockId { get; set; }
        /// <summary>
        /// 操作员
        /// </summary>
