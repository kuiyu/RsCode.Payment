...
namespace RsCode.Payment.Tenpay.V2.Partner
{
    /// <summary>
    /// 服务商-发送裂变红包
    /// <see cref="https://pay.weixin.qq.com/wiki/doc/api/tools/cash_coupon_sl.php?chapter=13_5&index=4"/>
    /// </summary>
    public class RedpacketGroupSendRequest : TenpayBaseRequest
    {
        #region 参数
        /// <summary>
        /// 随机字符串
        ...
        /// </summary>
        [JsonPropertyName("amt_type")] public string AmtType { get; set; } = "ALL_RAND";
